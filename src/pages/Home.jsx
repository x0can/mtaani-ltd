  ...
  return (
    <div className="container section">
      <div className="hero">
        ...
        <div className="heroCard" role="presentation" aria-hidden="true">
          <div className="heroCardTitle">Corporate Overview</div>
          <ul className="list">
            <li>Retail process enablement and digital access</li>
            <li>Product browsing, promotions, and engagement tools</li>
            <li>Partner/vendor coordination support</li>
            <li>Operational reporting and continuous improvement</li>
            <li>Governance, compliance, and policy transparency</li>
          </ul>
        </div>
      ...
      <div className="imageGrid sectionTight">
        <div className="imgCard">
          <img src="/images/retail.jpg" alt="Retail product browsing experience" />
          <div className="imgLabel">Customer Access</div>
        </div>
        <div className="imgCard">
          <img src="/images/operations.jpg" alt="Operational workflows and reporting" />
          <div className="imgLabel">Operational Efficiency</div>
        </div>
        <div className="imgCard">
          <img src="/images/compliance.jpg" alt="Governance and compliance documentation" />
          <div className="imgLabel">Governance & Compliance</div>
        </div>
      </div>
